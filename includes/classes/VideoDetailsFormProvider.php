...
class VideoDetailsFormProvider {
    ...
    private function createTitleInput($value) {
        if($value == null) $value = "";
        return "<div class='form-group'>
                    <input class='form-control mb-3' type='text' placeholder='Title' name='titleInput' value='$value'>
                </div>";
    }
    ...
    private function createDescriptionInput($value) {
        if($value == null) $value = "";
        return "<div class='form-group'>
                    <textarea class='form-control mb-3' placeholder='Description' name='descriptionInput' rows='3'>$value</textarea>
                </div>";
    }
    ...
    private function createPrivacyInput($value) {
        ...
        return "<div class='form-group'>
                    <select class='form-control mb-3' name='privacyInput'>
